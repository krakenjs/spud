...
util.inherits(AbstractReader, stream.Writable);

AbstractReader.prototype.__defineGetter__('data', function () {
	return this._data;
});

AbstractReader.prototype.__defineSetter__('data', function (value) {
	this._data = value;
});

AbstractReader.prototype._write = function (data, encoding, callback) {
 ...
 */
AbstractReader.prototype.deserialize = function (callback) {
 ...
 */
AbstractReader.prototype._doDeserialize = function (data, callback) {
